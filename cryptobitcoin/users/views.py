...
def UserPredictTestProcess(request,value):
    ...
    result = predictionstart(fileName)
    return render(request, 'users/predictTest.html', {'result': result})

    # return render(request,'users/predictTest.html',predictionstart(fileName))
